            ...
            <Form onSubmit={handleSubmit}>
                <Row className="mt-5 justify-content-center">
                    ...
                    <Col md={3} className="mb-5">
                        ...
                        <h6>Longueur de l’évaluation <i className="bi bi-question-circle" tilte="Évaluation standard : Format le plus long &#013; Évaluation raccourcie : Format raccourcie pour s'entrainer &#013; Test de positionnement: Format court pour se tester rapidement"></i></h6>
